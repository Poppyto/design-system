...
// TODO doc format https://en.wikipedia.org/wiki/ISO_8601
// TODO disabled style on month & year (ex when setting "min") (see https://ark-ui.canny.io/feature-requests/p/datepicker-month-and-year-disable-state)
...
interface DatepickerProp extends Omit<ComponentPropsWithRef<'div'>, 'defaultValue'> {
  dateFormatter?: (arg: DatepickerFormatterArg) => string,
  defaultOpen?: boolean,
  defaultValue?: Date | string,
  defaultView?: DatepickerView,
  disabled?: boolean,
  disabledDates?: Date[], // TODO ISSUE https://github.com/chakra-ui/ark/issues/3468
  disabledWeekDays?: DATEPICKER_DAY[], // TODO ISSUE => https://github.com/chakra-ui/ark/issues/3468
  locale?: string,
  max?: Date | string,
